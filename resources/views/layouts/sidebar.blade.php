...
<aside id="sidebar" class="w-48 bg-white border-r border-gray-200 flex flex-col flex-shrink-0 z-30 overflow-hidden">
    ...
    <nav id="sideNav" class="flex-1 overflow-y-auto overflow-x-hidden py-2.5 px-2">
        ...
        <a href="{{ route('dashboard') }}"
            class="nav-item flex items-center gap-2.5 px-2 py-2 rounded-lg text-sm font-medium transition-colors duration-150 mb-0.5 
    {{ request()->routeIs('dashboard') ? 'bg-[#047354] text-white active' : 'text-gray-500 hover:bg-gray-50 hover:text-gray-800' }}"
    ...
    {{ request()->routeIs('youtube-videos.index') ? 'bg-[#047354] text-white active' : 'text-gray-500 hover:bg-gray-50 hover:text-gray-800' }}"
            data-label="Videos">
        ...
        <a href="{{ route('slider-images.index') }}"
            class="nav-item flex items-center gap-2.5 px-2 py-2 rounded-lg text-gray-500 hover:bg-gray-50 hover:text-gray-800 text-sm font-medium transition-colors duration-150 mb-0.5
    {{ request()->routeIs('slider-images.index') ? 'bg-[#047354] text-white active' : 'text-gray-500 hover:bg-gray-50 hover:text-gray-800' }}"
            data-label="Sliders">
        ...
        <a href="{{ route('packages.index') }}"
            class="nav-item flex items-center gap-2.5 px-2 py-2 rounded-lg text-gray-500 hover:bg-gray-50 hover:text-gray-800 text-sm font-medium transition-colors duration-150 mb-0.5
    {{ request()->routeIs('packages.index') ? 'bg-[#047354] text-white active' : 'text-gray-500 hover:bg-gray-50 hover:text-gray-800' }}"
            data-label="Packages">
        ...
        <a href="{{ route('icons.index') }}"
            class="nav-item flex items-center gap-2.5 px-2 py-2 rounded-lg text-gray-500 hover:bg-gray-50 hover:text-gray-800 text-sm font-medium transition-colors duration-150 mb-0.5
    {{ request()->routeIs('icons.index') ? 'bg-[#047354] text-white active' : 'text-gray-500 hover:bg-gray-50 hover:text-gray-800' }}"
            data-label="Icons">
